...
[_QWERTY] = LAYOUT_dactyl_pretty_wrapper(
  ...
  KC_ESC,   ________________QWERTY_L2_________________,              ________________QWERTY_R2_________________, KC_QUOTE,
  KC_LSFT,  ________________QWERTY_L3_________________,              ________________QWERTY_R3_________________, KC_SFTENT,
...
[_DVORAK] = LAYOUT_dactyl_pretty_wrapper(
  ...
  KC_ESC,   ________________DVORAK_L2_________________,              ________________DVORAK_R2_________________, KC_MINUS,
  KC_LSFT,  ________________DVORAK_L3_________________,              ________________DVORAK_R3_________________, KC_SFTENT,
  ________________DOX_L4____________________,                                 ________________DOX_R4____________________,
                                        ________________DOXTHUMBS_________________
),
...
[_COLEMAK] = LAYOUT_dactyl_pretty_wrapper(
  ...
  KC_ESC,   ________________COLEMAK_L2________________,              ________________COLEMAK_R2________________, KC_QUOTE,
  KC_LSFT,  ________________COLEMAK_L3________________,              ________________COLEMAK_R3________________, KC_SFTENT,
  ________________DOX_L4____________________,                                 ________________DOX_R4____________________,
                                        ________________DOXTHUMBS_________________
),
...
[_WORKMAN] = LAYOUT_dactyl_pretty_wrapper(
  ...
  KC_ESC,   ________________WORKMAN_L2________________,              ________________WORKMAN_R2________________, KC_QUOTE,
  KC_LSFT,  ________________WORKMAN_L3________________,              ________________WORKMAN_R3________________, KC_SFTENT,
  ________________DOX_L4____________________,                                 ________________DOX_R4____________________,
                                        ________________DOXTHUMBS_________________
),
