 ...
 * |         |PrScr |      |CPgUp |      |      |      |           | Page |      |      |      |      |      |        |
 * |---------+------+------+------+------+------|      |           |  Up  |------+------+------+------+------+--------|
 * |         |ScrLk |      |CPgDn |      |      |------|           |------| Left | Down |  Up  |Right |      |        |
 * |---------+------+------+------+------+------|      |           | Page |------+------+------+------+------+--------|
 * |         |Pause |      |      |      |      |      |           | Down | Home | PgDn | PgUp | End  |      |        |
 * `---------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |       |      |      |      |      |                                       |      |      |      |      |      |
 *   `-----------------------------------'                                       `----------------------------------'
 *                                       ,-------------.           ,-------------.
...
[_RAISE] = LAYOUT_ergodox(
  // left hand
  _______, KC_F1,   KC_F2,   KC_F3,         KC_F4,   KC_F5,   KC_F11,
  _______, KC_PSCR, _______, LCTL(KC_PGUP), _______, _______, _______,
  _______, KC_SLCK, _______, LCTL(KC_PGDN), _______, _______,
  ...
  KC_PGDN, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,
                    _______, _______, _______, _______, _______,
